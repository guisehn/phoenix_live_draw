defmodule PhoenixLiveDraw.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: PhoenixLiveDraw.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PhoenixLiveDrawWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
